          ...
          <div class="row">
            ...
            <div class="col-lg-3 order-2 order-lg-1">
              ...
              <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal mb-5">
                <li class="mb-2"><a class="reset-anchor" href="shop.php?id_category=2">Shoes</a></li>
                <li class="mb-2"><a class="reset-anchor" href="shop.php?id_category=3">Clothes</a></li>
                <li class="mb-2"><a class="reset-anchor" href="shop.php?id_category=4">Watches</a></li>
                <li class="mb-2"><a class="reset-anchor" href="shop.php?id_category=5">Electronics</a></li>
              </ul>
            ...
            <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
              ...
              <div class="row">
                ...
                if (isset($_GET['id_category'])) {
                  echo "<script>console.log('ada id nya')</script>";
                  include "tampilkanProdukKategori.php";
                  include "sortValueProdukKategori.php";
                } else {
                  include "tampilkanProdukDropdown.php";
                  echo "<script>console.log('gak ada id nya')</script>";
                }
                ?>
    ...
    <script>
      $(document).ready(function () {
        $('#sortSelect').change(function () {
          ...
          $.ajax({
            type: 'POST',
            url: 'tampilkanProdukDropdown.php', // URL file PHP yang menangani permintaan
          ...
          $.ajax({
            type: 'POST',
            url: 'sortValueProdukKategori.php', // URL file PHP yang menangani permintaan
            data: { sortBy: sortBy, idCategory: idCategory }, // Mengirim nilai yang dipilih ke PHP dengan nama 'sortBy' dan 'idCategory'
            success: function (response) {
              // Lakukan sesuatu setelah mendapatkan respons dari server (opsional)
            },
            error: function () {
              // Tangani kesalahan jika terjadi saat mengirim permintaan AJAX
              alert('Terjadi kesalahan. Silakan coba lagi.');
