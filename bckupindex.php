  ...
  <div class="page-holder">
    ...
    <div class="container">
      ...
      <section class="pt-5">
        ...
        <div class="row">
          <div class="col-md-4"><a class="category-item" href="shop.php?id_category=3" href="tampilkanProduk.php?id_category=3"><img class="img-fluid"
                src="img/cat-img-1.jpg" alt="" /><strong class="category-item-title">Clothes</strong></a>
          </div>
          <div class="col-md-4">
            <div>
              <a class="category-item mb-4" href="shop.php?id_category=2" href="tampilkanProduk.php?id_category=2"><img class="img-fluid"
                src="img/cat-img-2.jpg" alt="" /><strong class="category-item-title">Shoes</strong></a>
              </div>
            <div>
            <a class="category-item" href="shop.php?id_category=4" href="tampilkanProduk.php?id_category=4"><img class="img-fluid" src="img/cat-img-3.jpg"
                alt="" /><strong class="category-item-title">Watches</strong></a>
            </div>   
               
          </div>
          <div class="col-md-4"><a class="category-item" href="shop.php?id_category=5" href="tampilkanProduk.php?id_category=5"><img class="img-fluid"
