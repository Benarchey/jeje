    ...
    <div class="page-holder bg-light">
      <header class="header bg-white">
        <div class="container px-lg-3">
          <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.php"><span class="fw-bold text-uppercase text-dark">JEJE</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                <a class="nav-link active" href="detail.php">Product detail</a>
                </li>
              ...
              <div class="row align-items-stretch">
                ...
                <div class="col-lg-6">
                  <div class="p-4 my-md-4">
                    ...
                    <p class="text-sm mb-4">Jam tangan dengan kualitas terbaik berwarna merah. Desai elegan dengan paduan warna hitam dan merah cocok digunakan untuk sehari hari</p>
          ...
          <div class="tab-content mb-5" id="myTabContent">
            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
              <div class="p-4 p-lg-5 bg-white">
                ...
                <p class="text-muted text-sm mb-0">KEEEREEENNNN</p>
              </div>
            </div>
                  ...
                  <div class="col-lg-8">
                    <div class="d-flex mb-3">
                      ...
                      <div class="ms-3 flex-shrink-1">
                        ...
                        <p class="text-sm mb-0 text-muted">Kiww kiwww</p>
                      </div>
                    </div>
                    <div class="d-flex">
                      ...
                      <div class="ms-3 flex-shrink-1">
                        ...
                        <p class="text-sm mb-0 text-muted">KEREEENNN</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="border-top pt-4" style="border-color: #1d1d1d !important">
            <div class="row">
              ...
              <div class="col-md-6 text-center text-md-end">
                <p class="small text-muted mb-0"><a class="text-white reset-anchor" href="https://www.instagram.com/_jee.jeee/">JEJE COMPANY</a></p>
