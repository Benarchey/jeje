...
if(isset($_GET['id'])){
    ...
    $sql = mysqli_query($is_connect, "delete from produk where id = $id");
    if($sql){
        echo '<div id="customAlert" class="custom-alert alert-success">Fitur Terakhir Berhasil!! Saatnya tidur</div>';
    }else{
        echo 'LOL';
    }
...
<style>
    ...
    .custom-alert {
        ...
        z-index: 9999; /* Untuk memastikan alert muncul di atas elemen lain */
    }
        ...
        <header class="header bg-white">
            <div class="container px-lg-3">
                <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand"
                        href="index.php"><span class="fw-bold text-uppercase text-dark">JEJE</span></a>
            ...
            <section class="py-5 bg-light">
                <div class="container">
                    <div class="row px-4 px-lg-5 py-lg-4 align-items-center">
                        <div class="col-lg-6">
                            <h1 class="h3 mb-0">Delete User</h1>
                        </div>
                                ...
                                <table class="table text-nowrap">
                                    <thead class="bg-light">
                                        <tr>
                                            ...
                                            <th class="border-0 p-3" scope="col"> <strong
                                                    class="text-sm text-uppercase">Delete</strong></th>
                                                ...
                                                <tr>
                                                    <th class="ps-0 py-3 border-light" scope="row">
                                                        <div class="d-flex align-items-center"><a
                                                                ...
                                                                href="detail.php"><img src="../img/<?= $data['image'] ?>"
                                                                    alt="..." width="70" /></a>
                                                            <div class="ms-3"><strong class="h6"><a
                                                                        class="reset-anchor animsition-link"
                                                                        href="detail.php"><?= $data['nama_produk'] ?></a></strong>
                                                            </div>
                                                        </div>
                                                    </th>

                                                    <td class="p-3 align-middle border-light"><a class="reset-anchor"
                                                            href="deleteProduk.php?id=<?= $data['id']?>"><i class="fas fa-trash-alt small text-muted"></i></a>
                                                    </td>
                                                </tr>
                                            <?php }
                                        } ?>
